...
global using static MoreExpressions.ModEntry.Global;
...
internal class ModEntry : Mod
{
    ...
    public override string? Description => "More facial expressions";
    ...
    {
        instance = this;
        CustomExpression.Setup(this);
    }
    public override object? GetApi() => Api.instance;
}
