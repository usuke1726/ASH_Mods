...
internal class CharacterObject
{
    ...
    internal Textures GetTextures(IEnumerable<Parts> required)
    {
        ...
        {
            var tex = Util.EditableTexture(Obj(p).GetComponent<SpriteRenderer>().sprite.texture);
            switch (p)
            {
    ...
    private static readonly Dictionary<Characters, string> querys = new()
    {
        ...
        [Characters.DadBoatDeer1] = QueryFrom("Fox", "Head_0"),
        [Characters.DadBoatDeer2] = QueryFrom("Fox", "Head_0"),
        [Characters.KidBoatDeer1] = QueryFrom("Fox", "Head_0"),
        [Characters.KidBoatDeer2] = QueryFrom("Fox", "Head_0"),
        [Characters.KidBoatDeer3] = QueryFrom("Fox", "Head_0"),
        [Characters.ShipWorker1] = QueryFrom("Fox", "Head_0"),
        [Characters.ShipWorker2] = QueryFrom("Fox", "Head_0"),
        [Characters.RumorGuy] = QueryFrom("Rabbit", "Head_0"),
        [Characters.Charlie1] = QueryFrom("Fox", "Head_0"),
        [Characters.Charlie2] = QueryFrom("Fox", "Head_0"),
        [Characters.Tim1] = QueryFrom("Rabbit", "Head_0"),
        [Characters.Tim2] = QueryFrom("Rabbit", "Head_0"),
        [Characters.Tim3] = QueryFrom("Fox", "Head_0"),
        [Characters.ClimbingRhino1] = QueryFrom("Fox", "Head_0"),
        [Characters.ClimbingRhino2] = QueryFrom("Fox", "Head_0"),
        [Characters.ClimbingRhino3] = QueryFrom("Fox", "Head_0"),
        ...
        [Characters.PictureFox1] = QueryFrom("Fox", "Head_0"),
        [Characters.PictureFox2] = QueryFrom("Character", "Head"),
        ...
        [Characters.Artist1] = QueryFrom("Fox", "Head_0"),
        [Characters.Artist2] = QueryFrom("Fox", "Head_0"),
        [Characters.Artist3] = QueryFrom("Fox", "Head_0"),
        [Characters.Artist4] = QueryFrom("Fox", "Head_0"),
        [Characters.Artist5] = QueryFrom("Fox", "Head_0"),
        [Characters.Artist6] = QueryFrom("Fox", "Head_0"),
