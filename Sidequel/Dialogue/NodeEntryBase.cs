...
#pragma warning disable IDE1006
    ...
    protected static LookAtAction lookTr(string character, Func<Transform?> getTarget, string? anchor = null) => new(character, getTarget, anchor);
    ...
    protected static UpdateContAction cont(int value, Func<bool>? condition = null, string? anchor = null) => new(value, condition, anchor);
