...
#pragma warning disable IDE1006
    ...
    protected static RangedLinesAction lines(int minInclusive, int maxInclusive, Func<int, string> getI18nKey, string speaker, Func<string, string>? replacer = null, bool useId = true, string? anchor = null) => new(minInclusive, maxInclusive, getI18nKey, speaker, replacer, useId, anchor);
    protected static RangedLinesAction lines(int minInclusive, int maxInclusive, Func<int, string> getI18nKey, Func<int, string> getSpeaker, Func<string, string>? replacer = null, bool useId = true, string? anchor = null) => new(minInclusive, maxInclusive, getI18nKey, getSpeaker, replacer, useId, anchor);
    protected static RangedLinesAction lines(int minInclusive, int maxInclusive, Func<int, string> getI18nKey, HashSet<int> playerIndexes, Func<string, string>? replacer = null, bool useId = true, string? anchor = null) => new(minInclusive, maxInclusive, getI18nKey, playerIndexes, replacer, useId, anchor);
    protected static IndexedLinesAction lines(Func<int, string> getI18nKey, string speaker, Func<string, string>? replacer = null, bool useId = true, string? anchor = null) => new(getI18nKey, speaker, replacer, useId, anchor);
    protected static IndexedLinesAction lines(Func<int, string> getI18nKey, Func<int, string> getSpeaker, Func<string, string>? replacer = null, bool useId = true, string? anchor = null) => new(getI18nKey, getSpeaker, replacer, useId, anchor);
    protected static IndexedLinesAction lines(Func<int, string> getI18nKey, HashSet<int> playerIndexes, Func<string, string>? replacer = null, bool useId = true, string? anchor = null) => new(getI18nKey, playerIndexes, replacer, useId, anchor);
